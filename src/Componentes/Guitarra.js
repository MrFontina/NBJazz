  ...
  return (
    ...
    <div id='guit-grid-medio'>
      <p > Entre los temas que podemos trabajar juntos, se incluyen: </p>
        <ul >
          <li><p className='p-title'>Conocimiento integral del diapasón: </p>
          ...
          <li><p className='p-title'> Armonía y construcción de acordes: </p>
          ...
          <li><p className='p-title'>Escalas: </p>
          ...
          <li><p className='p-title'>Intervalos:  </p>
