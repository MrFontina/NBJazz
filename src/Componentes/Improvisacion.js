    ...
    <main className={`main-section  ${isOpen ? "" : "main-section-no-margin"}`}>
      ...
      <div className='container-improvisacion'>
        <div className='container-grid-top'>
          <img src='../../Images/oink2.jpg' alt='grabacion disco oink' className='img-impro' id='impro-img-1'></img>
        <p id='impro-p1'>
        ...
        <div className='container-grid-bottom'>
          <img src='../../Images/barry.png' alt='clase con barry harris' className='img-impro' id='impro-img-2'></img>
        <p id='impro-p2'>
